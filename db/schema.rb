...
ActiveRecord::Schema.define(version: 20180414022007) do
  ...
  create_table "full_calls", force: :cascade do |t|
    ...
    t.integer  "urban_voate",  default: 0
    t.text     "oxford_def"
    t.text     "webster_def"
    t.text     "johnson_def"
    t.text     "urban_def"
    t.integer  "oxford_vote",  default: 0
  ...
  create_table "oxford_calls", force: :cascade do |t|
    t.string   "word"
    t.text     "definition"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sj_calls", force: :cascade do |t|
    t.string   "word"
    t.text     "definition"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "urban_calls", force: :cascade do |t|
    t.string   "word"
    t.text     "definition"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "webster_calls", force: :cascade do |t|
    t.string   "word"
    t.text     "definition"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
